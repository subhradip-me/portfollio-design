...
const allProjects = [
  ...
  },
  {
    ...
    category: 'Branding',
    year: '2024',
    tags: ['Identity', 'Strategy', 'Visual'],
    description: 'Complete brand system for tech startup',
    image: 'https://images.unsplash.com/photo-1542744094-24638eff58bb?w=1200&h=800&fit=crop',
    link: '#',
    featured: false
  },
  {
  ...
  },
  {
    ...
    category: 'Development',
    year: '2023',
    tags: ['Gatsby', 'GSAP', 'Performance'],
    description: 'High-performance portfolio with custom animations',
...
const categories = ['All', 'Development', 'Design', 'Branding', 'Mobile']
